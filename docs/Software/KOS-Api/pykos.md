...
<a id="sound.SoundServiceClient"></a>
...
<a id="sound.SoundServiceClient.__init__"></a>
...
<a id="sound.SoundServiceClient.get_audio_info"></a>
...
<a id="sound.SoundServiceClient.play_audio"></a>
...
<a id="sound.SoundServiceClient.record_audio"></a>
...
<a id="sound.SoundServiceClient.stop_recording"></a>
...
<a id="sim.SimServiceClient.reset"></a>
...
<a id="sim.SimServiceClient.set_paused"></a>
...
<a id="sim.SimServiceClient.step"></a>

#### step

```python
async def step(num_steps: int,
               step_size: float or None = None) -> common_pb2.ActionResponse
```
...
<a id="sim.SimServiceClient.set_parameters"></a>
...
<a id="sim.SimServiceClient.get_parameters"></a>
...
<a id="__init__.add_sync_version"></a>
...
<a id="__init__.AsyncClientBase"></a>
...
<a id="process_manager.ProcessManagerServiceClient"></a>
...
<a id="process_manager.ProcessManagerServiceClient.start_kclip"></a>
...
<a id="process_manager.ProcessManagerServiceClient.stop_kclip"></a>
...
<a id="inference.ModelMetadata"></a>
...
<a id="inference.TensorDimension"></a>
...
<a id="inference.ForwardResponse"></a>
...
<a id="inference.GetModelsInfoResponse"></a>
...
<a id="inference.InferenceServiceClient"></a>
...
<a id="inference.InferenceServiceClient.__init__"></a>
...
<a id="inference.InferenceServiceClient.upload_model"></a>
...
async def upload_model(
    model_data: bytes,
    metadata: ModelMetadata or None = None
...
<a id="inference.InferenceServiceClient.load_models"></a>
...
<a id="inference.InferenceServiceClient.unload_models"></a>
...
<a id="inference.InferenceServiceClient.get_models_info"></a>
...
<a id="inference.InferenceServiceClient.forward"></a>
...
<a id="imu.IMUServiceClient.get_imu_values"></a>
...
<a id="imu.IMUServiceClient.get_imu_advanced_values"></a>
...
<a id="imu.IMUServiceClient.get_euler_angles"></a>
...
<a id="imu.IMUServiceClient.get_quaternion"></a>
...
<a id="imu.IMUServiceClient.zero"></a>
...
<a id="imu.IMUServiceClient.calibrate"></a>
...
<a id="led_matrix.LEDMatrixServiceClient"></a>
...
<a id="led_matrix.LEDMatrixServiceClient.__init__"></a>
...
<a id="led_matrix.LEDMatrixServiceClient.get_matrix_info"></a>
...
<a id="led_matrix.LEDMatrixServiceClient.write_buffer"></a>
...
<a id="led_matrix.LEDMatrixServiceClient.write_color_buffer"></a>
...
<a id="actuator.ActuatorServiceClient"></a>
...
<a id="actuator.ActuatorServiceClient.calibrate"></a>
...
<a id="actuator.ActuatorServiceClient.get_calibration_status"></a>

#### get_calibration_status

```python
async def get_calibration_status(actuator_id: int) -> str or None
```

Get the calibration status of an actuator.

<a id="actuator.ActuatorServiceClient.command_actuators"></a>
...
<a id="actuator.ActuatorServiceClient.configure_actuator"></a>
...
<a id="actuator.ActuatorServiceClient.get_actuators_state"></a>
...
<a id="actuator.ActuatorServiceClient.move_to_position"></a>
...
async def move_to_position(positions: list[ActuatorPosition],
                           ...
                           torque_enabled: bool or None = None) -> None
```
...
<a id="actuator.ActuatorServiceClient.zero_actuators"></a>
