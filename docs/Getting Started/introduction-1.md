...
To help you get started with your robot, we've made a Python package called [Skillit](https://pypi.org/project/skillit/). With it, you can record actions by physically moving joints and saving them to json. All you need to do is `pip install skillit`

This package also supports playback from your json file, letting you capture complex movements with ease!
...
The source code and accompanying examples can be found [here](https://github.com/kscalelabs/skillit).