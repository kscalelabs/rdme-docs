...
*A Note:* The above assumes using STS3250 motors, with an aluminum body. If using STS3215's, with a plastic housing, most/all of the holes are *not* pre-tapped; you may be able to still use a regular screw, but self-tapping screws will make for an easier installation. Specifically:
